...
VDRest.app.de_DE = {
    ...
    "Syncing TV-Shows:": "Synchronisiere TV-Serien:",
    "Outdated:": "Veraltet:",
    "Import:": "Import:",
    "Found %d movies, %d episodes and %d shows to import.": "%d Filme, %d Episoden und %d Serien zu importieren.",
    "Found %d movies, %d episodes and %d shows to delete.": "%d Filme, %d Episoden und %d Serien zu löschen.",
    "%s\n%s\nProceed?": "%s\n%s\nWeiter?",
