...
Gui.Config.View.Window.FirstTime.prototype.helpDe = function () {
    ...
    this.addParagraph('Die Option \'Synchrones laden\' sollte nur aktiviert bleiben, wenn der VDR über wenig Kraftreserven verfügt. Dockstar und Co. fallen unter diese Kategorie.');
...
Gui.Config.View.Window.FirstTime.prototype.helpEn = function () {
    ...
    this.addParagraph('The option \'Load synced\' should be left active only if your VDR does not have much Power like Dockstar and other ARM devices.');
