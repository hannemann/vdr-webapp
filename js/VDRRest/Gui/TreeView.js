 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.setItems = function (items) {
    this.items = items;
    return this;
};
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.setRoot = function (root) {
    this.root = root;
    return this;
};
 ...
 * sort and render
 */
VDRest.Gui.TreeView.prototype.render = function () {
 ...
 */
VDRest.Gui.TreeView.prototype.moveFoldersToTop = function () {
 ...
 * unhide root items
 */
VDRest.Gui.TreeView.prototype.showRootItems = function () {
 ...
 */
VDRest.Gui.TreeView.prototype.renderRecursive = function (item, currentNode, pathNames) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.decorateItem = function (item, currentNode) {
    var dom = item.dom();
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.getDepth = function (item, pathNames) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.getDirectory = function (currentNode, pathName, depth) {
 ...
 * @return {Boolean}
 */
VDRest.Gui.TreeView.prototype.isRoot = function (currentNode) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.getPathName = function (pathNames) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.createDirectory = function (currentNode, pathName, depth) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.getWrapperNode = function (currentNode, pathName) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.getDirectoryWrapper = function (pathName, depth) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.getDirectoryLabel = function (pathName) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.getDirectoryContent = function (pathName) {
 ...
 * @return {*}
 */
VDRest.Gui.TreeView.prototype.addToggle = function (element) {
 ...
 * @return {Number}
 */
VDRest.Gui.TreeView.prototype.sortByName = function (a, b){
 ...
 * @return {Number}
 */
VDRest.Gui.TreeView.prototype.sortByDataNameAttribute = function (a, b){
